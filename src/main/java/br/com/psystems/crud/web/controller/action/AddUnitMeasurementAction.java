 ...
 *
 */
public class AddUnitMeasurementAction extends AbstractCrudAction<UnitMeasurement> implements Controllable, Mappable {

	public AddUnitMeasurementAction(UnitMeasurementService service) {
		super(service);
	}

	private static final long serialVersionUID = -9136913987730291078L;
	private static Logger logger = Logger.getLogger(AddUnitMeasurementAction.class);
