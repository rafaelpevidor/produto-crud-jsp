 ...
 *
 */
public class FindProductAction extends AbstractCrudAction<Product> implements Controllable {

	public FindProductAction(ProductService service) {
		super(service);
	}

	private static final long serialVersionUID = 7606485709102366372L;
	private static Logger logger = Logger.getLogger(FindProductAction.class);
