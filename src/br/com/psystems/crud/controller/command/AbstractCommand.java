...
//	private static final String UNEXPECTED_ERROR_ACTION_MESSAGE = "Desculpe, houve um erro inesperado ao executar a ação.";
	...
	protected void setFornecedores (final HttpServletRequest request, final List<Vendor> fornecedores ) {
		if (
				(null == fornecedores)||
	...
	protected void setProdutos (final HttpServletRequest request, final List<Product> produtos ) {
		if (
				(null == produtos)||
				(produtos.isEmpty())
		) {
